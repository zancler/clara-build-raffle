  ...
  return (
    <header className="relative bg-white border-b border-border overflow-hidden">
      ...
      <img 
        src={leftLine} 
        alt="" 
        className="absolute left-0 top-0 -translate-y-1/4 w-32 h-auto md:w-40 lg:w-60 md:-translate-x-4 lg:-translate-x-8"
        aria-hidden="true"
      />
      <img 
        src={rightLine} 
        alt="" 
        className="absolute right-0 top-0 -translate-y-1/4 w-40 h-auto md:w-48 lg:w-80 md:translate-x-4 lg:translate-x-8"
        aria-hidden="true"
      />
